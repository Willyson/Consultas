/*
	...
	TINY_WHOISACTIVE BY DIRCEU REZENDE
	LINK: https://www.dirceuresende.com/blog/sql-server-query-para-retornar-as-sessoes-ativas-sp_whoisactive-sem-consumir-tempdb/
...
IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.ROUTINES WHERE ROUTINE_NAME LIKE 'sp_Tiny_WhoIsActive')
BEGIN 
	EXEC ('CREATE PROCEDURE sp_Tiny_WhoIsActive AS SELECT 1 ')
END
GO

ALTER PROCEDURE dbo.sp_Tiny_WhoIsActive AS 
SELECT
